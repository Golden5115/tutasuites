...
export default async function LandingPage() {
  ...
  return (
    <>
      ...
      {/* About Section */}
      <section id="about" className="py-16 md:py-32 px-6 md:px-16 max-w-[1400px] mx-auto overflow-hidden">
      ...
      <section id="experience" className="py-16 md:py-32 px-6 md:px-16 bg-[#0d0d0d] overflow-hidden">
        <div className="max-w-[1400px] mx-auto">
          ...
          <StaggerContainer className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Luxury Suites */}
            <StaggerItem>
              <Link href="/rooms" className="block h-full group p-10 rounded-3xl border border-white/[0.06] hover:border-[#D4AF37]/30 bg-white/[0.02] hover:bg-white/[0.04] transition-all duration-500 flex flex-col items-center text-center">
            ...
            {/* Restaurant & Bar */}
            <StaggerItem>
              <div className="h-full group p-10 rounded-3xl border border-white/[0.06] hover:border-[#D4AF37]/30 bg-white/[0.02] hover:bg-white/[0.04] transition-all duration-500 flex flex-col items-center text-center">
      ...
      <section id="amenities" className="py-16 md:py-32 px-6 md:px-16 overflow-hidden">
        <div className="max-w-[1400px] mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
      ...
      <section id="testimonials" className="py-16 md:py-32 px-6 md:px-16 bg-[#0d0d0d] overflow-hidden">
        <div className="max-w-[1400px] mx-auto">
          <FadeIn direction="up">
            <div className="text-center mb-20">
          ...
          <StaggerContainer className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {TESTIMONIALS.map((t) => (
              <StaggerItem key={t.name}>
                <div
                  className="p-8 rounded-2xl bg-white/[0.02] border border-white/[0.06] flex flex-col h-full"
                >
      ...
      <section id="location" className="py-16 md:py-32 px-6 md:px-16 max-w-[1400px] mx-auto overflow-hidden">
