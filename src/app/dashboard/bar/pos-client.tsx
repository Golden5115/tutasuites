...
import { Minus, Plus, ShoppingCart, Trash2, Loader2, Wine, User, BedDouble, ChevronRight, X as XIcon, Link2 } from "lucide-react"
  ...
  return (
    <div className="space-y-4 animate-slide-up-delay-2 pb-24 lg:pb-0">
      ...
      <div className="flex items-center gap-2 overflow-x-auto pb-1 no-scrollbar">
        ...
        >
          <Link2 className="w-3.5 h-3.5" /> Link with Food Order
        </button>
      </div>
      ...
      <LinkSalesDialog
        ...
        initialBarOrderId={lastCreatedOrderId || undefined}
